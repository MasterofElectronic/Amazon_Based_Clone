...
import { Categort } from "../../categort/base/Categort";
...
export class ProductResolverBase {
  ...
  async createProduct(
    ...
    return await this.service.createProduct({
      ...
      data: {
        ...
        categort: args.data.categort
          ? {
              connect: args.data.categort,
            }
          : undefined,
  ...
  async getCategort(
    ...
    const result = await this.service.getCategort(parent.id);
